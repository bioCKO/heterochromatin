...
toPlot<-toPlot[-1]
colnames(toPlot)<-c("TOTAL", "INSERTIONS", "DELETIONS", "MISMATCHES")
...
heatmap.2(toPlot,dendrogram='none',Rowv=TRUE,Colv=FALSE,col=my_palette,trace="row",tracecol="gray",lmat=lmat,lwid=lwid,margins = c(12, 6))

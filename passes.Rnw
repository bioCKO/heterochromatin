...
plot(1:100,rowMeans(sapply(IPDlistPASS1, unlist),na.rm=TRUE),main="PASS 1",ylim=c(0,60),ylab="Mean IPD across all windows",xlab="window",col="red",pch=21)
plot(1:100,rowMeans(sapply(IPDlistPASS2, unlist),na.rm=TRUE),main="PASS 2",ylim=c(0,60),ylab="Mean IPD across all windows",xlab="window",col="red",pch=21)
plot(1:100,rowMeans(sapply(IPDlistPASS3, unlist),na.rm=TRUE),main="PASS 3",ylim=c(0,60),ylab="Mean IPD across all windows",xlab="window",col="red",pch=21)
plot(1:100,rowMeans(sapply(IPDlistPASS4, unlist),na.rm=TRUE),main="PASS 4",ylim=c(0,60),ylab="Mean IPD across all windows",xlab="window",col="red",pch=21)

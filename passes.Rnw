...
plot(
  1:100,
  rowMeans(sapply(IPDlistPASS1, unlist), na.rm = TRUE),
...
plot(
  1:100,
  rowMeans(sapply(IPDlistPASS2, unlist), na.rm = TRUE),
...
plot(
  1:100,
  rowMeans(sapply(IPDlistPASS3, unlist), na.rm = TRUE),
...
plot(
  1:100,
  rowMeans(sapply(IPDlistPASS4, unlist), na.rm = TRUE),

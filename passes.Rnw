...
passesStat <-read.table("21.GQuadPlusFeatureOnly.mf.gff.intersect")
...
.f = function() {
paddedIPDlistPASS1_0<-list()
paddedIPDlistPASS1_1<-list()
paddedIPDlistPASS2<-list()
paddedIPDlistPASS3<-list()
paddedIPDlistPASS4<-list()

for (i in 1:length(IPDlistPASS1_0)) { 
  print(i)
  paddedIPDlistPASS1_0[i]<-list(paddVector(IPDlistPASS1_0[i]))
}

for (i in 1:length(IPDlistPASS1_1)) { 
  print(i)
  paddedIPDlistPASS1_1[i]<-list(paddVector(IPDlistPASS1_1[i]))
}
...
motif<-"GQuadPlusFeatureOnly"

plot(
  1:100,
  rowMeans(sapply(paddedIPDlistPASS1_0, unlist), na.rm = TRUE),
  main = paste0("PASS 1 STRAND 0, n=", length(paddedIPDlistPASS1_0)),
  ylim = c(0, 10),
...
plot(
  1:100,
  rowMeans(sapply(paddedIPDlistPASS1_1, unlist), na.rm = TRUE),
  main = paste0("PASS 1 STRAND 1, n=", length(paddedIPDlistPASS1_1)),
  ylim = c(0, 10),
  ylab = "Mean IPD across all windows",
  xlab = "window",
  col = "red",

...
plotForTrio(trios[1:50,c("father89OfSon77","mother90OfSon77","son-77")],"son77 family")
plotForTrio(trios[1:50,c("father91OfDaughter78","mother92OfDaughter78","daughter-78")],"son77 family")
plotForTrio(trios[1:50,c("Father-HG","Mother-HG","Son-HG")],"Son-HG family")
